...
Detailed documentation for sandboxxer plugin features.
...
| [VARIABLES.md](VARIABLES.md) | Environment variables reference |
| [CUSTOMIZATION.md](CUSTOMIZATION.md) | Customizing DevContainer configurations |
...
- **Getting started?** See [SETUP-OPTIONS.md](SETUP-OPTIONS.md)
- **Having issues?** See [TROUBLESHOOTING.md](TROUBLESHOOTING.md)
- **Security concerns?** See [SECURITY-MODEL.md](SECURITY-MODEL.md)
