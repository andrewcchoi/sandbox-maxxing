...
Run:
```bash
ls -la "D:\!wip\plugins-sandbox\claude-code-sandbox-plugin\templates\python\"
```
...
Run:
```bash
ls -la "D:\!wip\plugins-sandbox\claude-code-sandbox-plugin\templates\node\"
```
...
Run:
```bash
ls -la "D:\!wip\plugins-sandbox\claude-code-sandbox-plugin\templates\fullstack\"
```
...
```bash
mkdir -p "D:\!wip\plugins-sandbox\claude-code-sandbox-plugin\tests"
```
...
Expected: See "claude-code-sandbox" in the list
